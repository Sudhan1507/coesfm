...
const NewProcurement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validate()) {
            ...
            formData.append('quotation_description', formFields.quotation_description);
        ...
        //         designate_manager: formFields.designate_manager
            ...
            try {
                const response = await axiosInstance.post(`/api/procurement/create-procurement`, formData, {
                    headers: {
    ...
    const handleChange = (e) => {
        ...
        if (type === 'file') {
            setFormFields(prevFields => ({
                ...prevFields,
                supporting_documents: [...prevFields.supporting_documents, ...Array.from(files)]
            }));
        ...
        <Body header="Procurement" breadcrumbItems={breadcrumbItems}>
            <div className='form-group-wrapper'>
                ...
                <div className="file-preview">
                    {formFields.supporting_documents.length > 0 && formFields.supporting_documents.map((file, index) => (
