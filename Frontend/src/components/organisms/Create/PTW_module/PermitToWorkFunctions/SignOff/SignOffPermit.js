...
const SignOffPermit = ({ row, onClose }) => {
    ...
    const handleSubmit = async () => {
        if (signaturePadRef.current) {
            ...
            if (signaturePadRef.current.isEmpty() || !signatureImage.startsWith('data:image/png;base64,')) {
        ...
        <>
            <div className="signOff-permit-wrapper">
                ...
                <div className="signoff-permit-form-signature">
                    <label className="signoff-permit-form-signature-text"><span className="required-asterisk">*</span>Signature</label>
