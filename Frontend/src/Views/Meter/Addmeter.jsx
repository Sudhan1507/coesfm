...
const AddMeter = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axiosInstance.post("/meter/add_meter", formData)
      .then((result) => {
        if (result.data.Status) {
          navigate('/meter');
        } else {
                                  ...
                                  <div className="p-3 rounded">
                                    ...
                                    <form className="row g-3" onSubmit={handleSubmit}>
                                      <div className="col-12">
                                        <label htmlFor="meter_name" className="form-label">
                                          Meter Name:
                                        </label>
                                        <input
                                          type="text"
                                      ...
                                      <div className="col-12">
                                        <label htmlFor="meter_unit" className="form-label">
                                          Meter Type:
                                        </label>
                                        <input
                                          type="text"
                                      ...
                                      <div className="col-12">
                                        <label htmlFor="install_on" className="form-label">
                                          Install on:
                                        </label>
                                        <input
                                          type="date"
                                      ...
                                      <div className="col-12">
                                        <label htmlFor="warranty_till" className="form-label">
                                          Warranty till:
                                        </label>
                                        <input
                                          type="date"
                                      ...
                                      <div className="col-12">
                                        <label htmlFor="asset_location" className="form-label">
