...
const Edit_Booking = () => {
  ...
  useEffect(() => {
      axiosInstance.get(`/booking/get_booking/${id}`)
          .then(result => {
            const bookingData = result.data.Result[0];  // Extract booking data from the result
            setBooking({
                ...bookingData,
          ...
          .catch(err => console.log("Error fetching booking details:", err));
  }, [id]);
