...
const QRCodePage = () => {
  ...
  useEffect(() => {
    ...
    axiosInstance.get(`/auth/api/${locQRID}`)
      .then((response) => {
  ...
  const urlToEncode = locationData
    ? `http://localhost:8080/display/fault_report?school_name=${encodeURIComponent(locationData.school_table_school_name)}&zone=${encodeURIComponent(locationData.zone)}&block=${encodeURIComponent(locationData.block)}&level=${encodeURIComponent(locationData.level)}&room_no=${encodeURIComponent(locationData.room_no)}&room_name=${encodeURIComponent(locationData.room_name)}`
    : '';
                                    ...
                                    <div style={{ textAlign: 'center', marginTop: '20px' }}>
                                      {locationData && (
                                        <>
                                          ...
                                          <QRCode value={urlToEncode} size={258} target='_blank' className="m-4" />
