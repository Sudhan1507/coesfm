...
import NewPT from '../../../../components/organisms/Create/PTW_module/NewPT/NewPT.jsx';
import Drawer from '../../../../components/molecules/Drawer/Drawer.jsx';
import DeleteOutlineSharpIcon from '@mui/icons-material/DeleteOutlineSharp';
import BorderColorOutlinedIcon from '@mui/icons-material/BorderColorOutlined';
import DeletePTW from '../../../../components/organisms/Delete/PTW_module/DeletePTW/DeletePTW.jsx';
import UpdatePTW from '../../../../components/organisms/Update/PTW_module/UpdatePTW/UpdatePTW.jsx';
...
const ManagePTW = () => {
  ...
  const getPermitTypes = useCallback(async () => {
    await axiosInstance.get('/permitType/fetch')
      .then((res) => {
  ...
  const handleSave = () => {
    ...
    showAlertHandler({
      type: 'success',
      message: updateRow ? 'Permit Type has been successfully updated.' : 'Permit Type has been successfully created.',
      duration: 3000,
  ...
  return (
    <Layout>
      {deleteId > 0 && <DeletePTW id={deleteId} onClose={onModalClose} name={deleteName} showAlert={showAlertHandler} />}
      ...
      >
        {updateRow ? (
          <UpdatePTW row={updateRow} onSave={handleSave} onCancel={handleCloseDrawer} showAlert={showAlertHandler} />
        ) : (
          <NewPT onSave={handleSave} onCancel={handleCloseDrawer} showAlert={showAlertHandler} />
        )}
      </Drawer>
      {showAlert.show && (
